...
public class ExcelReader {
	...
	public  int getLastcolumn(String filepath,String sheetname,int rownum)
	{
	
		
		Sheet shobj=workbook.getSheet(sheetname);
		if (shobj == null) {
			return 0;
		}
		Row rownumforcol=shobj.getRow(rownum);
		if (rownumforcol == null) {
			return 0;
		}
		int colnum=rownumforcol.getLastCellNum();
		return colnum;
	}
